# Copilot Instructions — `speakasap`
...
- **Authoritative path**: `/home/ssf/Documents/Github/speakasap` on the `alfares` server.
- **Origin**: `git@github.com:speakASAP/speakasap-new.git`, branch `main`.
