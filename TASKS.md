...
1. Goal 9.6: request owner approval for the scoped education-service deploy carrying the fixed five-minute salary duration rule, then rerun no-write salary readiness and calculation preview for `2026-05`.
