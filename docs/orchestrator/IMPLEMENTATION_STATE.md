...
Continue Goal 5 runtime verification: implement or verify scoped private playback/download access, merge/delete behavior, and failure modes before any frontend/gateway cutover.
